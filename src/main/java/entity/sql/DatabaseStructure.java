...
public class DatabaseStructure {
    ...
    public static final String COLUMN_MESSAGE_FROM = "from_user_id";

    public static final String COLUMN_MESSAGE_TO = "to_user_id";

    public static final String COLUMN_MESSAGE_CONTENT = "msg_content";

    public static final String COLUMN_MESSAGE_TIME = "send_time";
}
