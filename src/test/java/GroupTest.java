...
public class GroupTest {
    ...
    public void groupChatTest() throws SQLException {
        ...
        Msg msg = new Msg("test0@qq.com", "-1", new Timestamp(System.currentTimeMillis()), "Hello, I'm test0");
        Msg msg2 = new Msg("test1@qq.com", "-1", new Timestamp(System.currentTimeMillis()), "Hello, I'm test1");
    ...
    public void deleteGroup() throws SQLException {
        ...
        ChatSession chatSession = chatSessionInter.byId("-1");
        assert chatSession != null;
        msgInter.add(new Msg("test0@qq.com", "-1", new Timestamp(System.currentTimeMillis()), "Hello, I'm test0 in delete"));
